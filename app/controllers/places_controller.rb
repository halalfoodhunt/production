class PlacesController < ApplicationController
  ...
  def index
    ...
    marker.picture({
     "url" => "http://halalfoodhunt.com/friends/wp-content/uploads/2017/02/Asset-2pin.png",
     "width" =>  52,
     "height" => 52})
