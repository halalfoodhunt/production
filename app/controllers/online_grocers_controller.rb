class OnlineGrocersController < ApplicationController
  ...
  private
    ...
    def online_grocer_params
      params.require(:online_grocer).permit(:brand_name, :general_email, :location_id, :region_id, :qualifying_type_id, :price_range_id, :friends_reward_id, :contactable_hours, :general_contact_number, :website, :ordering_link, :friends_code, :facebook, :instagram, :question_1, :question_2, :question_3, :question_4, :question_5, :expiry_date, :halal_expiry, :friends_rewards_terms, :draft, :logo, :featured_image, :image, :image_2, :image_3, :image_4, grocer_type_ids: [], grocer_service_type_ids: [])
    end
end
