class OnlineGrocersController < ApplicationController
  ...
  private
    ...
    def online_grocer_params
      params.require(:online_grocer).permit(:brand_name, :general_email, :contactable_hours, :general_contact_number, :website, :ordering_link, :facebook, :instagram, :question_1, :question_2, :question_3, :question_4, :question_5, :expiry_date, :halal_expiry, :friends_rewards_terms, :merchant_id, :draft)
    end
end
