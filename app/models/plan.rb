class Plan < ActiveRecord::Base
  ...
  Plan.create({
    ...
    Plan.create({
      ...
      interval: 'month',
      stripe_id: 'social', 
      features: ['Unlimited Verified Listings', 'Unlimited Categories', 'Unlimited Highlights', 'Unlimited Locations', '5 Featured Questions', 'Meta Word Search', 'Reservation Listing', 'Delivery Listing', 'FRIENDS Reward', 'Email Function', 'Review/Feedback Add-on'].join("\n\n"), 
      display_order: 4
    })
